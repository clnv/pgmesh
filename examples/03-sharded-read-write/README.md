...
It also reads and writes `application_settings` through a separate generated
`Store` backed by one database. Both stores expose the same public interface
shape while their configurations keep account routing sharded and settings
routing unsharded.
