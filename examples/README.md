...
| [`03-sharded-read-write`](03-sharded-read-write) | Two physical shards, each with a replica | One `Store` with `Accounts` and `Reports` groups, virtual shards, separate settings store |
