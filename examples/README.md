...
| [`04-mirrors-and-transactions`](04-mirrors-and-transactions) | Two sharded primary/replica sets plus write mirrors | Synchronous mirrors, primary-pinned transactions, mirror suppression in transactions |
